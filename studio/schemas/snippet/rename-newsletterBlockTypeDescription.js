...
const fetchDocuments = () =>
  client.fetch(
    `*[_type == 'newsletterBlockType' && defined(newsletterBlockDescription)][0...100] {_id, _rev, newsletterBlockDescription}`
  )
...
const buildPatches = docs =>
  docs.map(doc => ({
    id: doc._id,
    patch: {
      set: {description: doc.newsletterBlockDescription},
      unset: ['newsletterBlockDescription'],
