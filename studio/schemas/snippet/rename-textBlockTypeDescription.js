...
const fetchDocuments = () =>
  client.fetch(
    `*[_type == 'textBlockType' && defined(textBlockDescription)][0...100] {_id, _rev, textBlockDescription}`
  )
...
const buildPatches = docs =>
  docs.map(doc => ({
    id: doc._id,
    patch: {
      set: {description: doc.textBlockDescription},
      unset: ['textBlockDescription'],
