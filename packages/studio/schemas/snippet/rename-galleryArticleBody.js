...
// ** example : sanity exec --with-user-token schemas/snippet/rename-galleryArticleBody.js**
...
const fetchDocuments = () =>
  client.fetch(
    `*[_type == 'galleryArticle' && defined(galleryBody)][0...100] {_id, _rev, sliderName}`
  )
