...
const fetchDocuments = () =>
  client.fetch(
    `*[_type == 'imageBlockType' && defined(imageBlockDescription)][0...100] {_id, _rev, imageBlockDescription}`
  )
...
const buildPatches = docs =>
  docs.map(doc => ({
    id: doc._id,
    patch: {
      set: {description: doc.imageBlockDescription},
      unset: ['imageBlockDescription'],
