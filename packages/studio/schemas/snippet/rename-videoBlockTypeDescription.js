...
const fetchDocuments = () =>
  client.fetch(
    `*[_type == 'videoBlockType' && defined(videoBlockDescription)][0...100] {_id, _rev, videoBlockDescription}`
  )
...
const buildPatches = docs =>
  docs.map(doc => ({
    id: doc._id,
    patch: {
      set: {description: doc.videoBlockDescription},
      unset: ['videoBlockDescription'],
